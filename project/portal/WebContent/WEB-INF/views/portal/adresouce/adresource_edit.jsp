			...
			<div class="widget-content no-padding">
				...
				<div class="form-row">
					...
					<div class="field">
						...
						<form:errors path="adImagea" cssClass="error"/>
						<form:errors path="adImageb" cssClass="error"/>
						<input type="file" name="adImagec" id="file">
						<input type="file" name="adImaged" id="file">
						<form:errors path="adImagec" cssClass="error"/>
						<form:errors path="adImaged" cssClass="error"/>
					</div>
				</div>
				<div class="form-row">
					...
					<div class="field">
						...
						<a href="${imgServer}${adResource.apkUrl}">下载apk</a>
