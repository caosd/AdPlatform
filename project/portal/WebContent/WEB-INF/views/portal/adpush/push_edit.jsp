	...
	<div class="widget">
		<form:form commandName="adPushForm" method="POST" class="form-horizontal form-wizard">
			...
			<div class="widget-content no-padding">
				...
				<div class="form-row">
					<label class="field-name" for="topPush">是否首推：</label>
					<div class="field">
						<div class="input-prepend input-append">
							<form:checkbox path="topPush" class="span12"/>
						</div>
						<form:errors path="topPush" cssClass="error"/>
					</div>
				</div>
				<div class="form-row">
				...
				<div class="form-row">
					<label class="field-name" for="dailyPush">设置每日最大推送量：</label>
					<div class="field">
						<div class="input-prepend input-append">
							<form:input path="dailyPush" class="span12"/> 
							<span class="add-on">*</span>
						</div>
						<form:errors path="dailyPush" cssClass="error"/>
					</div>
				</div>
				<div class="form-row">
